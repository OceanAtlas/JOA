/*
 * $Id: GridCartesianRenderer.java,v 1.33 2004/06/04 21:06:10 sirott Exp $
 *
 ...
 *
 * @author Donald Denbo
 * @version $Revision: 1.33 $, $Date: 2004/06/04 21:06:10 $
 * @since 1.0
 */
public class GridCartesianRenderer extends CartesianRenderer {
  ...
  public void draw(Graphics g) {
    ...
    if(attr_.isContour()) {
      ...
      con_ = new Contour(null, grid_, attr_.getContourLevels(), 2);
...
//    g.setClip(rect);
  ...
  private void fillSquare(Graphics g, double[] x,
    ...
    for(cindex=-1; cindex < maxindex; cindex++) {
      ...
      col = cmap.getColorByIndex(cindex+1);  // +1 for ContourLevels to Color index mapping
