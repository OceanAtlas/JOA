/*
 * $Id: AxisHolder.java,v 1.5 2004/04/29 22:31:52 sirott Exp $
 *
 ...
 *
 * @author Donald Denbo
 * @version $Revision: 1.5 $, $Date: 2004/04/29 22:31:52 $
 * @since 3.0
 **/
...
//  private double originP = 0.0;  //  y origin for X_DIR, x origin for Y_DIR if axisPosition = MANUAL
  ...
  private SGLabel title = new SGLabel(null, "title", "", 0.20,
  ...
  public AxisHolder(int type, int dir, DataGroup dataGroup) {
    ...
    if (type == DataGroup.TIME){
      userRange = new SoTRange.Time(0, 1000);
    }
