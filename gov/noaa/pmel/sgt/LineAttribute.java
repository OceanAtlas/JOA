/*
 * $Id: LineAttribute.java,v 1.21 2004/05/17 21:45:08 dwd Exp $
 *
 ...
 *
 * @author Donald Denbo
 * @version $Revision: 1.21 $, $Date: 2004/05/17 21:45:08 $
 * @since 1.0
...
public class LineAttribute implements Attribute, Cloneable {
  ...
  //private ColorMap assocCmap_ = null;
  ...
  **/
   ...
   * @return ColorMap
   */
  //public ColorMap getAssociatedDataCmap() {
  //  return assocCmap_;
  //}
  /**
   * @since 3.1
   * @param cmap ColorMap
   */
  //public void setAssociatedDataCmap(ColorMap cmap) {
  //assocCmap_ = cmap;
  //}
}
