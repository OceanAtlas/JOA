/*
 * $Id: SpaceAxis.java,v 1.10 2004/04/08 23:10:16 sirott Exp $
 *
 ...
 *
 * @author Donald Denbo
 * @version $Revision: 1.10 $, $Date: 2004/04/08 23:10:16 $
 * @since 1.0
 * @see Axis
 * @see PlainAxis
 * @see TimeAxis
...
public abstract class SpaceAxis extends Axis {
  ...
  public void setRangeU(SoTRange ur) {
    setRangeU(new Range2D(((Double)ur.getStartObject()).doubleValue(),
                          ((Double)ur.getEndObject()).doubleValue(),
                          ((Double)ur.getDeltaObject()).doubleValue()));
  }
  /**
   * Get the user range.
   *
