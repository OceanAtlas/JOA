/*
 * $Id: AxisTransform.java,v 1.12 2004/04/08 23:10:16 sirott Exp $
 *
 ...
 *
 * @author Donald Denbo
 * @version $Revision: 1.12 $, $Date: 2004/04/08 23:10:16 $
 * @since 1.0
 */
public abstract class AxisTransform implements Transform {
  ...
  public void setRangeU(SoTRange str) {
    if(str.isTime()) {
      ...
      setRangeU(((Double)str.getStartObject()).doubleValue(),
                ((Double)str.getEndObject()).doubleValue());
    }
  }
  /**
