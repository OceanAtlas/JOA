/**
 * $Id: SimpleGrid.java,v 1.21 2004/05/07 23:38:31 dwd Exp $
 *
 ...
 *
 * @author Donald Denbo
 * @version $Revision: 1.21 $, $Date: 2004/05/07 23:38:31 $
 * @since 1.0
 * @see SGTGrid
 * @see Cartesian
 */
...
//  protected GeoDate[] tEdges_;
   ...
   * @param title the title
   */
  public SimpleGrid(double[] grid, GeoDateArray tloc,
                    double[] yloc, String title) {
    grid_ = grid;
    tloc_ = tloc;
    yloc_ = yloc;
   ...
   */
  public SimpleGrid(double[] grid, double[] xloc,
                    GeoDateArray tloc, String title) {
    grid_ = grid;
    xloc_ = xloc;
    tloc_ = tloc;
    title_ = title;
