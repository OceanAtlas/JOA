/*
 * $Id: SGTVector.java,v 1.12 2004/05/10 23:16:03 dwd Exp $
 *
 ...
 *
 * @author Donald Denbo
 * @version $Revision: 1.12 $, $Date: 2004/05/10 23:16:03 $
 * @since 1.0
 * @see SGTData
...
public class SGTVector implements SGTData, Cloneable, Serializable {
  ...
  * @clientRole u comp*/
    protected SGTGrid uComp_ = null;
    /**@shapeType AggregationLink
  * @clientRole v comp*/
    protected SGTGrid vComp_ = null;
  /**
   * Default constructor.
   */
  public SGTVector() {
