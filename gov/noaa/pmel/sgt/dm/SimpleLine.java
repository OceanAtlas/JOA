/**
 * $Id: SimpleLine.java,v 1.18 2004/05/19 15:01:03 dwd Exp $
 *
 ...
 *
 * @author Donald Denbo
 * @version $Revision: 1.18 $, $Date: 2004/05/19 15:01:03 $
 * @since 1.0
 * @see SGTLine
 * @see Cartesian
 */
...
//  protected GeoDate[] tloc_;
  ...
  * @clientRole associated data*/
  ...
  protected SoTRange computeSoTRange(double[] array) {
    if(array == null) return new SoTRange.Double(Double.NaN, Double.NaN);
