/*
 * $Id: PointCollectionKey.java,v 1.10 2004/03/22 23:16:12 dwd Exp $
 *
 ...
 *
 * @author Donald Denbo
 * @version $Revision: 1.10 $, $Date: 2004/03/22 23:16:12 $
 * @since 2.0
**/
...
//    label.setLayer(layer_);
  ...
  throws IllegalArgumentException {
    if(!(rend instanceof PointCartesianRenderer))
      throw new IllegalArgumentException("Renderer is not a PointCartesianRenderer");
    removePointRenderer((PointCartesianRenderer)rend);
  }
  /**
