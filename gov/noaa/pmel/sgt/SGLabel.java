...
public class SGLabel {
   ...
   */
  public SGLabel(Component c, String id,String lbl,Point2D.Double loc) {
    this(c, id, lbl, 0.12, loc, BOTTOM, LEFT);
  }
  /**
   ...
   **/
  public SGLabel(Component c, String id, String lbl, double hgt,
                 Point2D.Double loc, int valign, int halign) {
    parent_ = c;
    //if(PaneProxy.Java2D) {
      proxy_ = new LabelDrawer2(c, lbl, hgt, loc, valign, halign);
    //} else {
...
//    }
  ...
  public SGLabel copy() {
    ...
    try {
      ...
      newLabel = new SGLabel(parent_, ident_,
                             proxy_.getText(),
                             proxy_.getHeightP(),
                             proxy_.getLocationP(),
                             proxy_.getVAlign(),
