/*
 * $Id: ConfigHXsec.java,v 1.4 2005/06/17 18:08:52 oz Exp $
 *
 */
...
public class ConfigHXsec extends JOAJDialog /*CloseableFrame*/ implements ActionListener {
  ...
  public ConfigHXsec(JOAWindow parent, DialogClient client, double min, double max, double inc, double dMin,
                     double dMax) {
    super(parent, "Configure Horizontal Cross Section", false);
    mClient = client;
    mMin = mOrigMin = min;
    mMax = mOrigMax = max;
    mInc = mOrigInc = inc;
  ...
  public ConfigHXsec(JOAWindow parent, DialogClient client, double min, double max, double inc, double dMin,
                     double dMax, double ovlmin, double ovlmax, double ovlinc, double ovldMin, double ovldMax) {
    super(parent, "Configure Horizontal Cross Section", false);
    mClient = client;
    mMin = mOrigMin = min;
    mMax = mOrigMax = max;
