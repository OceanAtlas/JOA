...
public class ConfigCustomCalc extends JOAJDialog implements ListSelectionListener, ActionListener, ButtonMaintainer,
  ...
  protected Vector<CustomCalculation> mPendingCalcs = new Vector<CustomCalculation>();
  protected int mOperand = JOAConstants.PLUS_OP;
  protected JOAJList mXParamJList;
  protected JOAJList mYParamJList;
	private Timer timer = new Timer();

  public ConfigCustomCalc(JFrame par, FileViewer fv) {
    super(par, "Custom Calculations", false);
    mFileViewer = fv;
    this.init();
  }
  ...
  public void init() {
    ...
    mXParamList = new ParameterChooser(mFileViewer, new String(b.getString("kParameter1")), this,
                                       "SALT                ");
    mYParamList = new ParameterChooser(mFileViewer, new String(b.getString("kParameter2Colon")), this,
                                       "SALT                ");
    mXParamList.init();
    mYParamList.init();
    ...
    mPendingCalcList.getSelectionModel().setSelectionMode(ListSelectionModel.SINGLE_SELECTION);
    mPendingCalcList.setPrototypeCellValue("SAL1 = SALT/0.000000 ");
  ...
  public void actionPerformed(ActionEvent e) {
    ...
    if (cmd.equals("cancel")) {
      ...
      for (int i = 0; i < mPendingCalcs.size(); i++) {
        CustomCalculation cc = (CustomCalculation)mPendingCalcs.elementAt(i);
      ...
      CustomCalculation cc = new CustomCalculation(newCalcName, newParam, units, (String)mXParamJList.getSelectedValue(),
      ...
      mNewParamName.setText("NP" + ++mNewParamCnt);
  ...
  public void generateParamName() {
    ...
    if (!integral.isSelected()) {
      ...
      param = (String)mXParamJList.getSelectedValue();
      nameString = new String("int" + param);
    }
