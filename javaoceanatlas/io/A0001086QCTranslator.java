 ...
 *
 */
public class A0001086QCTranslator implements QCTranslator {
	/*
...
*/
	public int translate(int inQC, WODQCStandard destConvention) {
		if (destConvention == WODQCStandard.WMO) {
			if (inQC == 3) { // doubtful data -> The element is probably bad
				return 3;
			}
			...
			if (inQC == 3) { // doubtful data -> Questionable measurement
				return 3;
			}
