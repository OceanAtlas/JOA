...
public class CustomCalculation {
    ...
    public CustomCalculation(String calcString, String newParam, String units, String operand1, String operand2, int op, double constant1, double constant2, boolean reverseY) {
