...
public class Eckert4Projection extends Projection {
	...
	private final int NITER = 12;

	public Point2D.Double project(double lplam, double lpphi, Point2D.Double out) {
		double p, V, s, c;
		int i;

		lpphi = lpphi * JOAConstants.F; // JOAConstants.F is degrees to radians
		if (lplam <= 180) {
			lplam = lplam - 360;
		}
		else {
		...
		lplam = lplam * JOAConstants.F; // JOAConstants.F is degrees to radians
