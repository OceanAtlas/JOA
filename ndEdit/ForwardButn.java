/*
 * $Id: ForwardButn.java,v 1.3 2005/02/15 18:31:09 oz Exp $
 *
 ...
 */
 public class ForwardButn extends JButton {


   private static final String gif = "gifs/forward.gif";
   ...
   public ForwardButn() {
     ...
     this.setRolloverEnabled(true);
        ...
        try {
	        ...
	        e.printStackTrace();
	      	System.out.println("ForwardButn:ctor");
        }
   }
 }
