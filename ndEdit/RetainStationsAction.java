/*
 * $Id: RetainStationsAction.java,v 1.7 2005/02/15 18:31:10 oz Exp $
 *
...
import ndEdit.*;
 ...
 public class RetainStationsAction extends NdEditAction {
    public RetainStationsAction(String menu, String text, Icon icon, ViewManager vm, NdEdit parent) {
        super(menu, text, icon, vm, parent);
    }
    
    public RetainStationsAction(String menu, String text, Icon icon, KeyStroke ks, ViewManager vm, NdEdit parent) {
