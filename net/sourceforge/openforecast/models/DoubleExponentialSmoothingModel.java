...
import javaoceanatlas.ui.TSModelTermUI;
...
public class DoubleExponentialSmoothingModel extends AbstractTimeBasedModel
{
    ...
    public String toString()
    {
		...
		/* (non-Javadoc)
     * @see net.sourceforge.openforecast.ForecastingModel#getIntercept()
     */
    public double getIntercept() {
		...
		/* (non-Javadoc)
     * @see net.sourceforge.openforecast.ForecastingModel#getModelTerms()
     */
